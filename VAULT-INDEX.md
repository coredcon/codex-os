...
|---|---|---|
| Canonex (GM Screen app) | Beta — shipped 2026-03-06 | Collect feedback from PF2e party Discord |
| Foundry Combat Lights | Idea / queued | Build Foundry→Govee automation: red on combat start |
| Desktop Familiar (Pi + Llama) | In progress | — |
...
| Item | Status | Notes |
|---|---|---|
| Backyard fence | Planning | DIY-directed, need help for heavy work |
| Garage | Backlog | Sort/purge/organize |
| Trash removal | Todo | Backyard/garage area |

## Inbox
> Items in `00 Inbox/` waiting to be processed.

- Count: 0
- Last processed: 2026-03-06
...
- [[04 Home/Honey-Do|Honey-Do List]]

---
*Update this file every Sunday during your weekly review.*
