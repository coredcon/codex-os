---
date: 2026-03-03
project: Echoes of The Forgotten Gods
status: active
tags: [ttrpg, pf2e, campaign]
---

# Echoes of The Forgotten Gods

**System:** Pathfinder 2e (Remaster)
**Role:** GM (Corey / "Kael" in-world)
**Status:** Active — main campaign
**Vault:** Separate Obsidian vault (this is the bridge/outbox)

## Campaign Notes
- Starstone Accord is a story arc within the campaign, not the campaign name
- Do not assume full context from bridge notes — the campaign vault is large
- Starting level: 11 (carrying over from AV) | Target ending: 20
- Launch: ~8 weeks from 2026-03-08
- Players: 4-5 | One missed much of AV, one new (observed AV finish, class TBD)
- Torbin + Lysis married in the 2-year gap; Torbin retraining Psychic → Wizard
- Aesephna Menhemes: original Roseguard cleric, defeated Belcorra 500 years ago, now risen as a celestial — emotional anchor and vision-giver for EotFG
- Session 0 plan: two-year gap recap → Aesephna vision (fall of constellation caused by lens use against Belcorra) → new character intro TBD
