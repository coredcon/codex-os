...
- Deleting processed async instruction files
...
- Any task requiring judgment about priorities or the user's life
...
## Session-Brief Upgrade

The overnight brief writes `.claude/session-brief.md` — a pre-digested startup file containing:
